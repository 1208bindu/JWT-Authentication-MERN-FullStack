...
function SignedInLinks() {
    ...
    return (
        ...
        <nav>
            ...
            <Link to='/' className="left brand-logo">Hello {currentUser ?(currentUser.firstname + currentUser.lastname):""}</Link>
        ...
        <ul  >
            <li className="card"><NavLink to ="/login" onClick={logout} className="sidenav-close ">LogOut</NavLink></li>
        </ul>
        </div>
        </>
    )
